...
Parte técnica: 
Desenvolvido em React Js, usando: Router, styled-components, states, API de CEP(consulta de CEP) e Context API(gerenciamento de state)
Futuramente o projeto: Irá calcular média, acessar um banco de dados.
