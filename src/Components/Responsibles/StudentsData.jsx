    ...
    return (
        <>
            <Content>
                ...
                {formik.errors.name_student && formik.touched.name_student ? <span>{formik.errors.name_student}</span> : null}
            </Content>

            <ContainerStudant>
            <Content>
            <FormControl>
                <InputLabel className="color" style={{paddingLeft: "15px"}}>Serie/Ano:</InputLabel>
                ...
                {formik.errors.scholl_year_student && formik.touched.scholl_year_student ? <span>{formik.errors.scholl_year_student}</span> : null}
            </Content>

            <Content>
                <FormControl>
                <InputLabel className="color" style={{paddingLeft: "15px"}}>Turma:</InputLabel>
                ...
                {formik.errors.scholl_Class_student && formik.touched.scholl_Class_student ? <span>{formik.errors.scholl_Class_student}</span> : null}
            </Content>
            ...
            <Content>
                ...
                {formik.errors.birthdate_student && formik.touched.birthdate_student ? <span>{formik.errors.birthdate_student}</span> : null}
            </Content>
            </ContainerStudant>
            ...
            <Button
                ...
                disabled={
                    (
                        formik.values.name && 
                        formik.values.birthdate_student)
                         ? false : true
                }
