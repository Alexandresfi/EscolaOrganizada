  ...
  return (
    <>
      ...
      <Content>
        ...
        {formik.errors.numberCard && formik.touched.numberCard ? (
          <span>{formik.errors.numberCard}</span>
        ) : null}
      </Content>
      ...
      <Content>
        ...
        />
        {formik.errors.training_institution &&
        formik.touched.training_institution ? (
          <span>{formik.errors.training_institution}</span>
        ) : null}
      </Content>
      ...
      <Content>
        ...
        />
        {formik.errors.training_date && formik.touched.training_date ? (
          <span>{formik.errors.training_date}</span>
        ) : null}
      </Content>
