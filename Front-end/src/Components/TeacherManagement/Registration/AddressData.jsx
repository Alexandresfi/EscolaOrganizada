    ...
    return (
        <>
            <Content>
                ...
                {formik.errors.zipCode && formik.touched.zipCode ? <span>{formik.errors.zipCode}</span> : null}
            ...
            <Content>
                ...
                {formik.errors.street && formik.touched.street ? <span>{formik.errors.street}</span> : null}
            </Content>
            ...
            <Content>
                ...
                {formik.errors.housenumber && formik.touched.housenumber ? <span>{formik.errors.housenumber}</span> : null}
            </Content>
            ...
            <Content>
                ...
                {formik.errors.complement && formik.touched.complement ? <span>{formik.errors.complement}</span> : null}
            </Content>
            ...
            <Content>
                ...
                {formik.errors.city && formik.touched.city ? <span>{formik.errors.city}</span> : null}
            </Content>
            ...
            <Content>
                ...
                {formik.errors.district && formik.touched.district ? <span>{formik.errors.district}</span> : null}
            </Content>
